export default {
  ...
  keys: {
    ...
    deleteKey: "删除密钥",
    resetWeight: "恢复权重",
    confirmResetWeight: "确定要将该分组所有密钥的权重重置为默认值吗？",
    resetWeightSuccess: "已重置 {count} 个密钥的权重",
    keyValue: "密钥值",
    keyStatus: "密钥状态",
    keyChannel: "通道类型",
    checkStatus: "检查状态",
    ...
    copyAllKeysToClipboard: "复制所有密钥到剪贴板",
    copyValidKeysToClipboard: "复制有效密钥到剪贴板",
    copyInvalidKeysToClipboard: "复制无效密钥到剪贴板",
    ...
    weightShort: "权重",
    weightUpdated: "权重已更新",
    editKeyWeight: "编辑密钥权重",
    keyWeightDescription: "权重越高，密钥被选中的概率越大。范围: 1-1000",
    weightTip: "权重越高被选中概率越大",
    resetWeightShort: "重置",
    resetKeyWeight: "重置密钥权重",
    keyWeightReset: "密钥权重已重置",
    sortByLastUsed: "最后使用",
    sortByWeight: "权重",
    sortByRequests: "请求数",
    sortByFailures: "错误数",
    ...
    keyDisabled: "密钥已禁用",
    clickOrDragFile: "点击或拖拽文件到此区域",
    onlyTxtFileSupported: "仅支持 .txt 文件",
    testResultTitle: "测试结果",
    testResultSuccess: "成功",
    testResultStatusCode: "状态码 {code}",
    testResultUnknownError: "未知错误",
    testResultCount: "{count} 个密钥",
    testResultDuration: "总耗时: {duration}",
    testResultDeleteSelected: "删除选中",
  ...
  logs: {
    ...
    logMessage: "日志消息",
    clearLogs: "清除日志",
    confirmClearLogs: "确定要清除所有请求日志吗？此操作不可恢复！",
    clearLogsSuccess: "已清除 {count} 条日志记录",
  ...
  settings: {
    ...
    maxValueError: "值不能大于{value}",
    inputNumber: "请输入数值",
    inputContent: "请输入内容",
    instantDisableRulesPlaceholder: "每行一条规则，例如：\nstatus:401\nkeyword:invalid_api_key\n# 以 # 开头的行为注释",
    saveSettings: "保存设置",
    saving: "保存中...",
