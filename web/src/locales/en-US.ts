export default {
  ...
  keys: {
    ...
    confirmResetWeight: "Are you sure you want to reset the weight of all keys in this group to default?",
    resetWeightSuccess: "Reset weight for {count} keys",
    keyValue: "Key Value",
    ...
    copyAllKeysToClipboard: "Copy All Keys to Clipboard",
    copyValidKeysToClipboard: "Copy Valid Keys to Clipboard",
    copyInvalidKeysToClipboard: "Copy Invalid Keys to Clipboard",
    ...
    editKeyWeight: "Edit key weight",
    keyWeightDescription: "Higher weight means higher probability of being selected. Range: 1-1000",
    weightTip: "Higher weight = higher selection probability",
    resetWeightShort: "Reset",
    resetKeyWeight: "Reset key weight",
    keyWeightReset: "Key weight has been reset",
    sortByLastUsed: "Last Used",
    sortByWeight: "Weight",
    sortByRequests: "Requests",
    sortByFailures: "Failures",
    sortAsc: "Ascending",
    sortDesc: "Descending",
    ...
    clearGroupStats: "Clear Group Stats",
    confirmClearGroupStats: "Are you sure you want to clear {period} stats for this group?",
    clearGroupStatsSuccess: "Cleared {period} stats. {count} records updated.",
    ...
    testResultStatusCode: "Status {code}",
    testResultUnknownError: "Unknown Error",
    testResultCount: "{count} keys",
    testResultDuration: "Total: {duration}",
    testResultDeleteSelected: "Delete Selected",
  ...
  logs: {
    ...
    confirmClearLogs: "Are you sure to clear all request logs? This action cannot be undone!",
    clearLogsSuccess: "Cleared {count} log records",
  ...
  settings: {
    ...
    maxValueError: "Value cannot be greater than {value}",
    inputNumber: "Please input number",
    inputContent: "Please input content",
    instantDisableRulesPlaceholder: "One rule per line, e.g.:\nstatus:401\nkeyword:invalid_api_key\n# Lines starting with # are comments",
