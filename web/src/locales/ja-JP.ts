export default {
  ...
  keys: {
    ...
    deleteKey: "キー削除",
    resetWeight: "重み復元",
    confirmResetWeight: "このグループのすべてのキーの重みをデフォルト値にリセットしますか？",
    resetWeightSuccess: "{count} 個のキーの重みをリセットしました",
    keyValue: "キー値",
    keyStatus: "キーステータス",
    keyChannel: "チャンネルタイプ",
    ...
    copyAllKeysToClipboard: "すべてのキーをクリップボードにコピー",
    copyValidKeysToClipboard: "有効なキーをクリップボードにコピー",
    copyInvalidKeysToClipboard: "無効なキーをクリップボードにコピー",
    ...
    weightShort: "重み",
    weightUpdated: "重みが更新されました",
    editKeyWeight: "キー重みを編集",
    keyWeightDescription: "重みが高いほど選択される確率が高くなります。範囲: 1-1000",
    weightTip: "重みが高いほど選択確率が上がります",
    resetWeightShort: "リセット",
    resetKeyWeight: "キー重みをリセット",
    keyWeightReset: "キー重みがリセットされました",
    sortByLastUsed: "最終使用",
    sortByWeight: "重み",
    sortByRequests: "リクエスト数",
    sortByFailures: "エラー数",
    sortAsc: "昇順",
    sortDesc: "降順",
    ...
    clickOrDragFile: "クリックまたはファイルをドラッグ",
    onlyTxtFileSupported: ".txtファイルのみサポート",
    testResultTitle: "テスト結果",
    testResultSuccess: "成功",
    testResultStatusCode: "ステータス {code}",
    testResultUnknownError: "不明なエラー",
    testResultCount: "{count} 個のキー",
    testResultDuration: "合計: {duration}",
    testResultDeleteSelected: "選択を削除",
  ...
  logs: {
    ...
    logMessage: "ログメッセージ",
    clearLogs: "ログクリア",
    confirmClearLogs: "すべてのリクエストログをクリアしてもよろしいですか？この操作は元に戻せません！",
    clearLogsSuccess: "{count}件のログレコードをクリアしました",
  ...
  settings: {
    ...
    maxValueError: "値は{value}より大きくできません",
    inputNumber: "数値を入力してください",
    inputContent: "内容を入力してください",
    instantDisableRulesPlaceholder: "1行に1ルール、例：\nstatus:401\nkeyword:invalid_api_key\n# で始まる行はコメントです",
    saveSettings: "設定を保存",
    saving: "保存中...",
